    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          "**`/postpone request`** — request to move your next fixture (pick timezone + proposed date/time; no response in 24h counts as a denial; staff after 2 denials)",
      ...
      },
      {
        ...
        value: [
          ...
          "**`/disband`** — wipe a club/nation roster + manager for a season (fresh slate for `/appoint`)",
          "**`/backlog`** — all pending staff approvals (whitelist, VF Create, media, releases, contract signings)",
          "**`/postpone force`** — immediately reschedule a fixture by match ID (date, time, timezone)",
