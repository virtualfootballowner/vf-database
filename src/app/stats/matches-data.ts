...
const RAW: RawMatch[] = [
  ...
  ["EL1-NS-01", 1, "EuroLeague", "GW2", "2023-07-29", "Newport", "Stafford", 4, 0, "Group", "No", "—", "Date approximate"],
  ["EL1-NTS-01", 1, "EuroLeague", "GW7", "2023-08-12", "Nottingham", "Stafford", 3, 0, "Group", "Yes", "—", "FFT - Date approximate"],
