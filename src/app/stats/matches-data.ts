...
const RAW: RawMatch[] = [
  ...
  ["BP2-MNH-01", 2, "British Premier", "GW1", "2024-11-14", "Milton", "Newham", 0, 0, "Group", "No", "—", "0-0 vs Newham (was conflated with BP2-MN-01 Milton v Newport 2-3). Date approximate"],
  ["BP2-MN-01", 2, "British Premier", "GW1", "2024-11-15", "Milton", "Newport", 2, 3, "Group", "No", "—", "Milton v Newport (not Newham). GW1 slot; rescheduled / date approximate"],
