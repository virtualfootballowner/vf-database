...
const MESSAGES: Record<string, { title: string; body: string }> = {
  not_in_guild: {
    ...
    body:
      "We couldn't find your Discord account in the VF Media server. Join it, then start again from the staff verify page.",
  },
  nick_forbidden: {
  ...
  discord_state: {
    ...
    body: "Open the verify page again and start from **Continue**.",
  },
  discord_token: {
  ...
  session_expired: {
    ...
    body:
      "Verification took too long. Go back and start again.",
  },
  discord_api: {
...
export default async function VerifyMediaStaffDonePage({ searchParams }: Props) {
